...
public class SimpleProfileTest {
    ...
    public void is_shouldReturnBooleanValueForExistingKey() {
        Profile profile = new SimpleProfile(asAttributeList(SOME_KEY, TRUE));
    ...
    public void is_shouldReturnDefaultBooleanForMismatchingType() {
        Profile p = new SimpleProfile(asAttributeList(SOME_KEY, "String"));
    ...
    public void getAttribute_shouldReturnStringValueForExistingKey() {
        Profile profile = new SimpleProfile(asAttributeList(SOME_KEY, STRING_VALUE));
    ...
    public void getAttribute_shouldReturnNullValueForMismatchingType() {
        Profile profile = new SimpleProfile(asAttributeList(SOME_KEY, INTEGER_VALUE));
    ...
    public void findAttributeStartingWith_shouldReturnNullForMismatchingType() {
        Profile profile = new SimpleProfile(asAttributeList(STARTS_WITH, INTEGER_VALUE));
    ...
    public void findAttributeStartingWith_shouldReturnValueForMatchingKey() {
        Profile profile = new SimpleProfile(asAttributeList(STARTS_WITH + ":restOfKey", INTEGER_VALUE));
    ...
    private static List<Attribute> asAttributeList(String key, Object o) {
